...
// Source: loyalty-service/internal/handler (interfaces: AuthService)
//
// Generated by this command:
//
//	mockgen -destination=mocks/auth_service.go -package=mocks . AuthService
//
...
func (m *MockAuthService) ValidateToken(ctx context.Context, token string) (int, error) {
	m.ctrl.T.Helper()
